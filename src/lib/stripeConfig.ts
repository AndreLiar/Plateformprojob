...
if (typeof window === 'undefined') {
  ...
  console.log(`  ExportedTrimmedIsSet: ${!!STRIPE_PUBLISHABLE_KEY}`);
  ...
  console.log(`  ExportedTrimmedIsSet: ${!!STRIPE_SECRET_KEY}`);
  if (!STRIPE_SECRET_KEY) {
    console.warn("  CRITICAL: NEXT_STRIPE_SECRET_KEY is missing or empty. Stripe API calls will fail on the server.");
  }
  ...
  console.log(`  ExportedTrimmedIsSet: ${!!STRIPE_JOB_POST_PRICE_ID}`);
